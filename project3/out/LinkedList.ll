...
define i1 @Element.Equal(i8* %this, i8* %.other){
	...
	%_12 = call i1 %_11( i8* %this, i32 %_13, i32 %_16 )
	%_17 = xor i1 1, %_12
...
if1:
	...
	%_30 = call i1 %_29( i8* %this, i32 %_31, i32 %_34 )
	%_35 = xor i1 1, %_30
...
define i1 @Element.Compare(i8* %this, i32 %.num1, i32 %.num2){
	...
	br i1 %_4, label %if15, label %if16
if15:
	store i1 0, i1* %retval
	br label %if17
if16:
...
loopstart0:
	...
	br label %andclause0
andclause0:
	br i1 %_8, label %andclause1, label %andclause3
andclause1:
...
andclause2:
	br label %andclause3
andclause3:
	%_11 = phi i1 [ 0, %andclause0 ], [ %_10, %andclause2 ]
...
next1:
	...
	%_18 = call i1 %_17( i8* %_12, i8* %_19 )
	br i1 %_18, label %if21, label %if22
if21:
	store i1 1, i1* %ret_val
	%_20 = load i32, i32* %aux04
	%_21 = icmp slt i32 %_20, 0
	br i1 %_21, label %if24, label %if25
if24:
...
if25:
	...
	%_39 = load i8**, i8*** %_38
	%_40 = getelementptr i8*, i8** %_39, i32 8
	%_41 = load i8*, i8** %_40
	%_42 = bitcast i8* %_41 to i8* (i8*)*
	%_43 = call i8* %_42( i8* %_37 )
	%_36 = call i1 %_35( i8* %_30, i8* %_43 )
...
if23:
	...
	%_46 = xor i1 1, %_45
	br i1 %_46, label %if27, label %if28
if27:
...
loopstart3:
	...
	%_7 = xor i1 1, %_6
	br i1 %_7, label %next4, label %end5
next4:
	%_8 = load i8*, i8** %e
	...
	%_15 = load i8*, i8** %var_elem
	%_14 = call i1 %_13( i8* %_8, i8* %_15 )
	br i1 %_14, label %if30, label %if31
if30:
...
loopstart6:
	%_6 = load i1, i1* %var_end
	%_7 = xor i1 1, %_6
	br i1 %_7, label %next7, label %end8
next7:
