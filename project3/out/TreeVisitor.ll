...
loopstart0:
	%_11 = load i1, i1* %cont
	br i1 %_11, label %next1, label %end2
next1:
...
if10:
	...
	%_50 = load i8*, i8** %new_node
	%_49 = call i1 %_48( i8* %_43, i8* %_50 )
	store i1 %_49, i1* %ntb
	br label %if11
if11:
	br label %if8
...
loopstart3:
	%_0 = load i1, i1* %cont
	br i1 %_0, label %next4, label %end5
next4:
...
if27:
	...
	br label %andclause0
andclause0:
	br i1 %_52, label %andclause1, label %andclause3
andclause1:
...
andclause2:
	br label %andclause3
andclause3:
	%_61 = phi i1 [ 0, %andclause0 ], [ %_60, %andclause2 ]
...
if31:
	...
	%_67 = call i1 %_66( i8* %this, i8* %_68, i8* %_69 )
	store i1 %_67, i1* %ntb
	br label %if32
if32:
	br label %if29
...
if37:
	...
	%_55 = call i1 %_54( i8* %this, i32 %_56, i32 %_57 )
	br i1 %_55, label %if39, label %if40
if39:
...
loopstart6:
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5( i8* %_0 )
	br i1 %_6, label %next7, label %end8
next7:
...
loopstart9:
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5( i8* %_0 )
	br i1 %_6, label %next10, label %end11
next10:
	%_7 = load i8*, i8** %c_node
	%_8 = bitcast i8* %_7 to i8***
	%_9 = load i8**, i8*** %_8
...
loopstart12:
	%_0 = load i1, i1* %cont
	br i1 %_0, label %next13, label %end14
next13:
	%_1 = load i8*, i8** %current_node
	%_2 = bitcast i8* %_1 to i8***
	%_3 = load i8**, i8*** %_2
...
if54:
	...
	%_12 = call i1 %_11( i8* %this, i8* %_19 )
	store i1 %_12, i1* %ntb
	br label %if56
if55:
	store i1 1, i1* %ntb
...
if57:
	...
	%_39 = call i1 %_38( i8* %this, i8* %_46 )
	store i1 %_39, i1* %ntb
	br label %if59
if58:
	store i1 1, i1* %ntb
...
define i32 @Visitor.visit(i8* %this, i8* %.n){
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5( i8* %_0 )
	br i1 %_6, label %if60, label %if61
if60:
	%_7 = load i8*, i8** %n
	%_8 = bitcast i8* %_7 to i8***
	%_9 = load i8**, i8*** %_8
...
if62:
	...
	br i1 %_31, label %if63, label %if64
if63:
	%_32 = load i8*, i8** %n
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n){
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5( i8* %_0 )
	br i1 %_6, label %if66, label %if67
if66:
	%_7 = load i8*, i8** %n
	%_8 = bitcast i8* %_7 to i8***
	%_9 = load i8**, i8*** %_8
...
if68:
	...
	br i1 %_38, label %if69, label %if70
if69:
	%_39 = load i8*, i8** %n
	%_40 = bitcast i8* %_39 to i8***
	%_41 = load i8**, i8*** %_40
